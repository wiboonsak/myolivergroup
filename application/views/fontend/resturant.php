...
<body>
	...
	<?php include("header.php"); ?>
		...
		<section class="pager-sec" style="background-image: url(<?php echo base_url('HTML/images/banner_top3.jpg')?>)">
			<div class="container">
				<div class="pager-sec-details">
					<h3><?php echo $this->lang->line('Restaurants');?></h3>
					<ul>
						<li><a href="#" title=""><?php echo $this->lang->line('home');?></a></li>
						<li><span><?php echo $this->lang->line('Restaurants');?></span></li>
					</ul>
		...
		<section class="c-block pb-5" >
			<div class="container">
				<div class="sec-title">
					<h3><?php echo $this->lang->line('OLIVERRESTURANT');?></h3>
					<p><?php echo $this->lang->line('WithanAllDayDining');?></p>
				</div><!--sec-title end-->
			</div>
			<div class="rooms-carousel gl_sec">
				<div class="room-slide">
					<div class="room-details">
						<img src="<?php echo base_url('HTML/images/slider/food-712665_1920.jpg')?>" alt="">
					</div><!--room-details end-->
				</div>
				<div class="room-slide">
					<div class="room-details">
						<img src="<?php echo base_url('HTML/images/slider/salmon-518032_1920.jpg')?>" alt="">
					</div><!--room-details end-->
				</div>
				<div class="room-slide">
					<div class="room-details">
						<img src="<?php echo base_url('HTML/images/slider/restaurant-449952_1920.jpg')?>" alt="">
					</div><!--room-details end-->
				</div>
				<div class="room-slide">
					<div class="room-details">
						<img src="<?php echo base_url('HTML/images/slider/the-drink-4288621_1920.jpg')?>" alt="">
					</div><!--room-details end-->
				</div>
